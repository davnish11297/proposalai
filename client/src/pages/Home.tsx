      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <button className="text-gray-600 hover:text-gray-900 transition">Our story</button>
            <Link to="/login" className="text-gray-600 hover:text-gray-900 transition">Sign in</Link>
            <Link to="/register" className="ml-2 px-4 py-2 rounded-lg bg-orange-600 text-white font-semibold hover:bg-orange-700 transition">Get started</Link>
          </nav>
        </div>
      </header>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              <input
                ...
                placeholder="I want to create a platform for..."
