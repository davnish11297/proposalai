          ...
          {!showContent ? (
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-10 flex flex-col items-center justify-center min-h-[480px] mx-auto">
                  ...
                  {predefinedSuggestions.map((suggestion, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium transition-all duration-200 cursor-pointer border flex items-center gap-1.5 rounded-sm ${
              ...
              <div className="flex gap-4 mt-2 w-full justify-center">
                <button
                  className="px-6 py-2 bg-orange-600 text-white font-bold shadow-md hover:bg-orange-700 transition disabled:opacity-60 rounded-sm"
                ...
                <button
                  className="px-6 py-2 bg-gray-200 text-gray-700 font-bold shadow-md hover:bg-gray-300 transition rounded-sm"
                  onClick={() => {
                    setProposalText('');
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 max-w-7xl mx-auto">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="flex gap-3">
                  <button
                    className="px-4 py-2 bg-orange-600 text-white font-bold shadow-md hover:bg-orange-700 transition disabled:opacity-60 flex-1 rounded-sm"
                    onClick={async () => {
                      setGenerating(true);
                  ...
                  <button
                    className="px-4 py-2 bg-gray-200 text-gray-700 font-bold shadow-md hover:bg-gray-300 transition rounded-sm"
                    onClick={() => {
                      setProposalText('');
                      setSelectedSuggestions([]);
                      setUploadedPdfContent('');
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    ...
                    className="px-4 py-2 bg-green-600 text-white font-semibold hover:bg-green-700 transition disabled:opacity-60 flex-1 rounded-sm"
                  >
                    {savingDraft ? 'Saving...' : 'Save Draft'}
                  </button>
                  <button
                    onClick={() => setShowEmailModal(true)}
                    className="px-4 py-2 bg-orange-600 text-white font-semibold hover:bg-orange-700 transition rounded-sm"
                  >
                    Send Email
                  </button>
                  <button
                    ...
                    className="px-4 py-2 bg-purple-600 text-white font-semibold hover:bg-purple-700 transition disabled:opacity-60 rounded-sm"
                  >
            ...
            <div className="flex gap-3 justify-end mt-6">
              <button
                onClick={() => {
                  ...
                  setClientName('');
                                                                     ...
                                                                     className="px-4 py-2 bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300 transition rounded-sm"
                disabled={sendingEmail}
              >
                Cancel
              </button>
              <button
                onClick={handleSendEmail}
                                                                     className="px-4 py-2 bg-orange-600 text-white font-semibold shadow hover:bg-orange-700 transition disabled:opacity-60 rounded-sm"
