...
export default function HomePage() {
  ...
  // Don't render main content if user is logged in (will redirect)
  if (user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LoadingSpinner size="lg" />
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-blue-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8 text-base font-semibold">
            ...
            <Link href="/login" className="text-gray-700 hover:text-blue-700 transition">Login</Link>
            <Link href="/register" className="ml-2 px-6 py-2 rounded-lg bg-blue-600 text-white font-bold shadow hover:bg-blue-700 transition">Get Started</Link>
          </nav>
      ...
      <section className="max-w-5xl mx-auto px-4 py-24 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
          <Link href="/register" className="px-8 py-3 rounded-lg bg-blue-600 text-white font-bold text-lg shadow-md hover:bg-blue-700 transition">
            Get Started Free
          </Link>
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <Link href="/register" className="px-10 py-4 rounded-lg bg-blue-600 text-white font-bold text-xl shadow-md hover:bg-blue-700 transition">
          Get Started Free
        </Link>
      </section>
    </div>
